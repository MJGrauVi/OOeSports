...
const DIRECTORIO_CSS_FRONTEND = "/app/View/frontend/template/css/";
const DIRECTORIO_IMG_FRONTEND = "/app/View/frontend/template/img/";
const DIRECTORIO_JS_FRONTEND = "/app/View/frontend/template/js/";
